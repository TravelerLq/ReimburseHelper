...
public class PopViewSecondAdapter extends BaseAdapter {
    ...
    public interface OnItemClickListener {
        void onItemClick(PopViewSecondAdapter adapter, int position);
    }
    ...
    public PopViewSecondAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.e("second item pos=",keyValueBean.getValue());
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mOnItemClickListener != null) {
                    ...
                    mOnItemClickListener.onItemClick(PopViewSecondAdapter.this, position);
                }
            }
        });
