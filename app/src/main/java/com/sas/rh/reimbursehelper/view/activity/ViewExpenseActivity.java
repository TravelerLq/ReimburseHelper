...
public class ViewExpenseActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                //返回的mData 是null
                ToastUtil.showToast(ViewExpenseActivity.this, "通信异常，请检查网络连接！", Toast.LENGTH_LONG);
            }
            //
            if (msg.what == -1) {
                ToastUtil.showToast(ViewExpenseActivity.this, "通信模块异常！", Toast.LENGTH_LONG);
    ...
    protected void initData() {
        ...
        dialogLoading = ProgressDialog.show(ViewExpenseActivity.this, "", "数据获取中...", false);
        if (type.equals("0")) {
            //报销人
    ...
    private void initView() {
        adapter = new ExpenseAdapter(ViewExpenseActivity.this, mData);
        ...
        Integer userId = 3;
               */
                if (type.equals("0")) {
                    ...
                    intent.setClass(ViewExpenseActivity.this, ExpenseDetailActivity.class);
                } else {
                    //审批人
                    intent.setClass(ViewExpenseActivity.this, ApprovalDetailActivity.class);
                    //intent.setClass(ViewExpenseActivity.this, ViewApprovalDetailActivity.class);
                }
    ...
    Runnable GetApprovalExpense = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                jsonResult = getPendApproval((Integer) spu.getUidNum());
