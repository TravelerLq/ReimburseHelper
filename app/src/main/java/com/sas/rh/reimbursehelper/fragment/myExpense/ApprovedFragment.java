...
public class ApprovedFragment extends BaseFragment {
    ...
    private ProgressDialogUtil pdu = new ProgressDialogUtil(ApprovedFragment.this.getActivity(),
            "提示", "正在加载...");
...
//                }
    ...
    protected void initViews(View self, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) self.findViewById(R.id.rl_approved);
...
//        pdu.showpd();
    ...
    Runnable GetApprovedRunnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                JSONArray jo = ApprovalUtil.getMyExpenseApproved(spu.getUidNum());
                if (jo != null) {
                    jsonresult = jo;
