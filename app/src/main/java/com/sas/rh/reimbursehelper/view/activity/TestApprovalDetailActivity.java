...
public class TestApprovalDetailActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        context = TestApprovalDetailActivity.this;
        // context = getApplicationContext();
        spu = new SharedPreferencesUtil(TestApprovalDetailActivity.this);
        tvTitle.setText("报销单详情");

        myHandler = new MyHandler(this);
        SharedPreferencesUtil spu = new SharedPreferencesUtil(TestApprovalDetailActivity.this);
    ...
    private class MyHandler extends Handler {
        ...
        private final WeakReference<TestApprovalDetailActivity> mActivty;

        public MyHandler(TestApprovalDetailActivity activity) {
            mActivty = new WeakReference<TestApprovalDetailActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            TestApprovalDetailActivity activity = mActivty.get();
...
//                        ToastUtil.showToast(ApprovalDetailActivity.this, "验签成功！", Toast.LENGTH_LONG);
                        ...
                        ToastUtil.showToast(TestApprovalDetailActivity.this, "提交验签失败，请重新！", Toast.LENGTH_LONG);
                    }
                } else if (msg.what == 5) {
                    if (annexId != null) {
                        //去下载pdf
                    ...
                    ToastUtil.showToast(TestApprovalDetailActivity.this, "通信异常，请检查网络连接！", Toast.LENGTH_LONG);
                } else if (msg.what == -1) {
                    ToastUtil.showToast(TestApprovalDetailActivity.this, "通信模块异常！", Toast.LENGTH_LONG);
                }
            }
        }
    }
    ...
    private static final Runnable getTstData = new Runnable() {
...
//                    annexId = jsonobj.getInteger("annexId");
    ...
    private void signVerifyP1(final String base64Code1) {
        ...
        TestApprovalDetailActivity.this.getIntent().putExtra("data", plantext);
        TestApprovalDetailActivity.this.getIntent().putExtra("type", DataProcessType.SIGNATURE_P1.name());
        SignatureP1Service signatureP1Service = new SignatureP1Service(TestApprovalDetailActivity.this, new ProcessListener<DataProcessResponse>() {
            @Override
