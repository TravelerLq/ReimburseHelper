...
public class DeparrtmentEntity {

    String depatment_ID;
    String department_Name;
    String department_IsActived;

    public DeparrtmentEntity() {
    }

    public DeparrtmentEntity(String depatment_ID, String department_Name) {
        this.depatment_ID = depatment_ID;
        this.department_Name = department_Name;
    }

    public DeparrtmentEntity(String depatment_ID, String department_Name, String department_IsActived) {
        this.depatment_ID = depatment_ID;
        this.department_Name = department_Name;
