...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
  ...
  final public static int TYPE_ADD = 1;
  final public static int TYPE_PHOTO = 2;
  ...
  @Override public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      case TYPE_ADD:
        itemView = inflater.inflate(com.sas.rh.reimbursehelper.R.layout.item_add, parent, false);
        break;
      case TYPE_PHOTO:
